...
var app = new _vue2.default({
  ...
  methods: {
    readTodo: function readTodo() {
      ...
      if (this.currentUser) {
        var query = new _leancloudStorage2.default.Query('AVTodos');
    ...
    addTodo: function addTodo() {
      var d = new Date();
      var data = d.getFullYear() + '年' + (d.getMonth() + 1) + '月' + d.getDate() + '日 ' + d.getHours() + ':' + d.getMinutes();
      this.todoList.push({
        title: this.newTodo,
        createdAt: data,
        done: false
    ...
    updateTodos: function updateTodos() {
      ...
      var todo = _leancloudStorage2.default.Object.createWithoutData('AVTodos', this.todoList.id);
    ...
    saveTodo: function saveTodo() {
      ...
      var dataString = JSON.stringify(this.todoList);
      var AVTodos = _leancloudStorage2.default.Object.extend('AVTodos');
    ...
    login: function login() {
      ...
      _leancloudStorage2.default.User.logIn(this.formData.username, this.formData.password).then(function (lofindeUser) {
